...
import ActivityTools from "./ActivityTools";
import TemplateTools from "./TemplateTools";
import MultimediaTools from "./MultimediaTools";
import AudioBasedTools from "./AudioBasedTools";
      ...
      <div className="px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="rounded-xl bg-gradient-to-r from-[#3CA4F7] to-[#4F6CE1] text-white py-8 sm:p-8 relative flex flex-col items-center">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-center">
            Craft beautiful, bite-sized learning content—faster than ever.
          </h1>
        ...
        {/* Horizontal Divider */}
        <div className="border-t border-gray-200 my-2 mb-1"></div>
